...
class GustPreset extends Preset
{
    ...
    {
        // Mix Config
        copy(__DIR__ . '/gust-stubs/webpack.mix.js', base_path('webpack.mix.js'));

        // TailwindCSS Config
        copy(__DIR__ . '/gust-stubs/tailwind.config.js', base_path('tailwind.config.js'));
        ...
        copy(__DIR__ . '/gust-stubs/css/app.css', resource_path('css/app.css'));
        copy(__DIR__ . '/gust-stubs/css/base/all.css', resource_path('css/base/all.css'));
        copy(__DIR__ . '/gust-stubs/css/base/typography.css', resource_path('css/base/typography.css'));
        copy(__DIR__ . '/gust-stubs/css/base/media.css', resource_path('css/base/media.css'));
        copy(__DIR__ . '/gust-stubs/css/components/all.css', resource_path('css/components/all.css'));
        ...
        copy(__DIR__ . '/gust-stubs/js/app.js', resource_path('js/app.js'));
        copy(__DIR__ . '/gust-stubs/js/components/.gitkeep', resource_path('js/components/.gitkeep'));
    }
